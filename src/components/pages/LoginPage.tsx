  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok && data.accessToken && data.refreshToken) {
        ...
        // Update auth store if it has a method to set tokens
        if (login) {
        ...
        <div className="bg-[#111111] rounded-2xl p-8 shadow-2xl">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 bg-black border-gray-800 rounded text-[#15e49e] focus:ring-[#15e49e] focus:ring-offset-0"
                />
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-gray-500">
              ...
              <Link to="/terms" className="text-[#15e49e] hover:text-[#13c589]">
                Terms of Service
              </Link>{' '}
              and{' '}
              <Link to="/privacy" className="text-[#15e49e] hover:text-[#13c589]">
                Privacy Policy
              </Link>
            </p>
          </div>
